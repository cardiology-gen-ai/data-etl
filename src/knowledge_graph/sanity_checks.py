...
from knowledge_graph.sanity_check_recommendation import RECOMMENDATION_CHECKS

logger = logging.getLogger(__name__)


ALLOWED_MODES = {"structure", "entities", "embeddings", "recommendations", "full"}
...
PHASE_EXPANSION: Dict[str, Set[str]] = {
    ...
    "full": {"structure", "entities", "embeddings", "recommendations"},
}
...
CHECKS.extend(RECOMMENDATION_CHECKS)

...
ALLOWED_TYPES = {
    ...
    # Added for recommendation-structured extraction:
    "clinical_outcome",
    "dose_or_regimen",
}
...
_RAW_TYPE_ALIASES = {
    ...
    # dose_or_regimen aliases
    "dose": "dose_or_regimen",
    "dosage": "dose_or_regimen",
    "regimen": "dose_or_regimen",
    "schedule": "dose_or_regimen",
    "dosing": "dose_or_regimen",
    "dosing regimen": "dose_or_regimen",
}

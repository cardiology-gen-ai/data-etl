#!/usr/bin/env python3
"""Apply the multi-document prebuilt indexing patch to cardiology-gen-ai/data-etl.
...
def replace_once(path: Path, old: str, new: str, label: str) -> None:
    ...
    if count != 1:
        raise SystemExit(
            ...
            "Repository code likely changed; inspect before patching."
        )
